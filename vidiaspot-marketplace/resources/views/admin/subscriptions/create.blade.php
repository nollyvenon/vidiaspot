...
<div class="admin-card">
    <div class="flex justify-between items-center mb-4">
        <h2 class="text-lg font-semibold">Create New Subscription Plan</h2>
        <a href="{{ route('admin.subscriptions.index') }}" class="admin-btn admin-btn-primary">← Back to Subscriptions</a>
    </div>
    
    <form id="subscription-form" method="POST" action="{{ route('admin.subscriptions.store') }}">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                <div class="admin-form-group">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required class="admin-form-input" placeholder="Plan name">
                    @error('name')
                ...
                <div class="admin-form-group">
                    ...
                    <input type="text" name="slug" value="{{ old('slug') }}" required class="admin-form-input" placeholder="plan-slug">
                    @error('slug')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="admin-form-group">
                    ...
                    <input type="number" step="0.01" name="price" value="{{ old('price') }}" required class="admin-form-input" placeholder="0.00">
                    @error('price')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="admin-form-group">
                    ...
                    <input type="text" name="currency_code" value="{{ old('currency_code', 'NGN') }}" required class="admin-form-input" placeholder="NGN">
                    @error('currency_code')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="admin-form-group">
                    ...
                    <input type="number" name="duration_days" value="{{ old('duration_days', 30) }}" required class="admin-form-input" placeholder="30">
                    @error('duration_days')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div>
                <div class="admin-form-group">
                    ...
                    <textarea name="description" class="admin-form-input" rows="4" placeholder="Plan description">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="admin-form-group">
                    ...
                    <input type="number" name="ad_limit" value="{{ old('ad_limit', 0) }}" required class="admin-form-input" placeholder="0">
                    @error('ad_limit')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="admin-form-group">
                    ...
                    <input type="number" name="featured_ads_limit" value="{{ old('featured_ads_limit', 0) }}" required class="admin-form-input" placeholder="0">
                ...
                <div class="admin-form-group">
                    <label class="admin-form-label">
                        <input type="checkbox" name="has_priority_support" value="1" {{ old('has_priority_support') ? 'checked' : '' }} class="mr-2">
                        Priority Support
                    </label>
                </div>
