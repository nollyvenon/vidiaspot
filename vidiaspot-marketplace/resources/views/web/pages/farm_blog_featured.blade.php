...
@section('title', 'Featured Farm Articles - VidiaSpot')
@section('meta_description', 'Read our featured articles about farming practices, sustainability, and direct farm sales.')
@section('meta_keywords', 'featured farm articles, farming practices, organic farming, sustainable agriculture, farm tips')
...
<div class="container py-5">
    <div class="row">
        <div class="col-lg-8">
            <div class="mb-4">
                <h2 class="fw-bold mb-3">Featured Farm Articles</h2>
                <p class="text-muted">Curated selection of our best content about farming and agriculture</p>
            </div>
            ...
            <div class="text-center py-5">
                ...
                <h4>No featured articles available</h4>
                <p class="text-muted">Check back later for featured farm content</p>
        ...
        <div class="col-lg-4">
                        ...
                        <a href="{{ route('blog.show', $post->slug) }}" 
                           class="list-group-item list-group-item-action">
                            <div class="d-flex justify-content-between">
                                ...
                                <span class="badge bg-success">{{ $post->published_at->diffForHumans() }}</span>
                            </div>
                        </a>
                        @empty
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted">Receive our latest farm insights and tips directly to your inbox</p>
                    <form>
                        <div class="mb-3">
